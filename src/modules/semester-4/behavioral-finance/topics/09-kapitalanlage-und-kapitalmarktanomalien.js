...
export const meta = {
  ...
  sections: [
    { id: 'informationseffizienz', title: 'Traditionelle Theorie: Informationseffizienz' },
    { id: 'traditional-vs-behavioral', title: 'Traditional vs. Behavioral Finance' },
    { id: 'kapitalmarktanomalien', title: 'Anomalien an den Finanzmärkten' },
    { id: 'winner-loser-effekt', title: 'Winner-Loser-Effekt' },
    { id: 'value-effekt', title: 'Value-Effekt' },
    { id: 'risikopraemie', title: 'Risikoprämie als Anlagestrategie' },
    { id: 'size-und-momentum-effekt', title: 'Size- und Momentum-Effekt' },
    { id: 'idealtypischer-kurstrend', title: 'Idealtypisches Muster eines Kurstrends' },
  ],
  keyTakeaways: [
