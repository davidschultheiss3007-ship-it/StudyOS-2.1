...
export const meta = {
  ...
  estimatedMinutes: 60,
  sections: [
    { id: 'investmentprozess-zyklus', title: 'Der Investmentprozess als Kreislauf' },
    { id: 'investmentziele-und-restriktionen', title: 'Investmentziele, Restriktionen und Renditeansätze' },
    { id: 'saa-pm-finanzcontrolling', title: 'SAA, Portfoliomanagement i.e.S. und Finanzcontrolling' },
    { id: 'diversifikation-und-risiken', title: 'Diversifikation und Risiken der Kapitalanlage' },
    { id: 'asset-allocation-ebenen', title: 'Asset Allocation: Definition und Ebenen' },
    { id: 'bedeutung-der-saa', title: 'Die Bedeutung der strategischen Asset Allocation' },
    { id: 'taktische-asset-allocation', title: 'Taktische Asset Allocation' },
  ],
  keyTakeaways: [
    ...
    'Asset Allocation verteilt das Kapital über Diversifikationsebenen: strategisch auf Assetklassen, Länder und Währungen, taktisch auf Branchen und Einzeltitel.',
