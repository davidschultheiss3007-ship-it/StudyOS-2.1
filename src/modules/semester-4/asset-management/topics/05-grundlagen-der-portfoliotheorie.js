...
export const meta = {
  ...
  estimatedMinutes: 90,
  sections: [
    { id: 'markowitz-und-zwei-asset-portfolio', title: 'Markowitz und das Zwei-Wertpapier-Portfolio' },
    { id: 'risiko-grosser-portfolios-und-inputdaten', title: 'Risiko großer Portfolios und Inputdaten' },
    { id: 'effizienzkurve-korrelation-leerverkaeufe', title: 'Effizienzkurve, Korrelation und Leerverkäufe' },
    { id: 'gemeinsames-und-unabhaengiges-risiko', title: 'Gemeinsames und unabhängiges Risiko' },
    { id: 'systematisches-und-unsystematisches-risiko', title: 'Systematisches und unsystematisches Risiko' },
    { id: 'minimum-varianz-portfolio-und-kritik', title: 'Minimum-Varianz-Portfolio und kritische Würdigung' },
    { id: 'tobin-separation-und-cml', title: 'Tobin-Separation und Capital Market Line' },
    { id: 'capm-beta-sml', title: 'CAPM, Beta, SML und Marktportfolio' },
    { id: 'multifaktormodelle-und-apt', title: 'Multifaktormodelle und Arbitrage Pricing Theory' },
  ],
  keyTakeaways: [
