...
export const meta = {
  ...
  estimatedMinutes: 65,
  sections: [
    { id: 'performanceanalyse-im-finanzcontrolling', title: 'Performanceanalyse im Finanzcontrolling' },
    { id: 'systematik-der-performancemasse', title: 'Systematik der Performancemaße' },
    { id: 'geld-vs-zeitgewichtete-rendite', title: 'Geld- vs. zeitgewichtete Rendite' },
    { id: 'sharpe-ratio', title: 'Sharpe-Ratio' },
    { id: 'treynor-ratio', title: 'Treynor-Ratio' },
    { id: 'sharpe-vs-treynor', title: 'Sharpe- vs. Treynor-Ranking' },
    { id: 'jensen-alpha', title: 'Jensen-Alpha' },
    { id: 'bewertung-und-vergleich', title: 'Bewertung der drei risikoadjustierten Maße' },
  ],
  keyTakeaways: [
