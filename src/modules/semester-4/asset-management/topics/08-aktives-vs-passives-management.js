...
export const meta = {
  ...
  sections: [
    ...
    { id: 'indexanwendungen-und-indexindustrie', title: 'Indexanwendungen und Indexindustrie', pages: 'Folien 9–12' },
    { id: 'differenzierung-und-gewichtung', title: 'Differenzierung und Gewichtung von Indizes', pages: 'Folien 13–14, 17–21' },
  ...
  keyTakeaways: [
    ...
    'Die Benchmark ist im passiven Management das zu replizierende Zielportfolio, im aktiven Management das zu „schlagende" Portfolio durch Über-/Untergewichtungen; Indizes werden zusätzlich für Reporting, Asset-Allocation-Szenarien, Handel, Abwicklung, Risk-Management und Controlling genutzt.',
    'Ein Index ist ein investierbares Musterportfolio (nachbildbar, liquide, transparent) und differenziert sich nach Mitgliederzahl (Auswahl- vs. Benchmarkindex), Gewichtung (Preis vs. Kapitalisierung vs. Free-Float vs. Gleichgewichtung) und Dividendenbehandlung (Kurs- vs. Performanceindex); wichtige Aktienindizes reichen von selektiven Auswahlindizes bis zu breiten Benchmarkindizes.',
  ...
  examFocus: [
    ...
    'Anforderungen an Indizes (Nachbildbarkeit, Liquidität, Transparenz), die vier Funktionen und typische Indexanwendungen im Asset-Management-Prozess nennen.',
