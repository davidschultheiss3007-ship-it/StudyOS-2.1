...
export const meta = {
  ...
  estimatedMinutes: 90,
  sections: [
    { id: 'durchschnittswerte', title: 'Durchschnitts- und Renditemaße' },
    { id: 'erwartete-rendite-und-anleihen', title: 'Erwartete Rendite und Anleihenbewertung' },
    { id: 'zinsaenderungsrisiken', title: 'Zinsänderungsrisiken: Duration und Konvexität' },
    { id: 'volatilitaet-und-normalverteilung', title: 'Volatilität und Normalverteilung' },
    { id: 'hoehere-momente', title: 'Höhere Momente: Schiefe und Wölbung' },
    { id: 'value-at-risk', title: 'Value-at-Risk (VaR)' },
    { id: 'kovarianz-korrelation-diversifikation', title: 'Kovarianz, Korrelation und Diversifikation' },
  ],
  keyTakeaways: [
